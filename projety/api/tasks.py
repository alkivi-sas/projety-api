...
from flask import abort, current_app, g, request, jsonify
...
def before_first_request():
    ...
    def clean_old_tasks():
        """Clean up old tasks from our in-memory data structure."""
        global tasks
        while True:
...
def async(f):
    """
    Decorator to make task asynchronous.
